...
from keras.layers import Input, LSTM, TimeDistributed, Dense, Bidirectional, Layer
...
def preTrainingModel(trainingUsers,
    ...
    if saveCheckpoints == True:
        if onTpu:
            modelCheckpoint = ModelCheckpoint(filepath, monitor='val_accuracy', verbose=0, save_best_only=True, mode='max')
        else:
            ...
            for amountOfGestures in fineTuningGestureList:
                for amountOfRepetitions in fineTuningRepetitionList:
                    ...
                    if validation == 'inter-subject-split':
                        ...
                        trainingStepsPerEpoch = allNumOfTrainingSamples // batchSize
                        directory = baseDrive+"data/dbb"
                        workingDirectory = baseDrive+'data/inter-session-correct/dbb/'
...
'''
#szombat ejjel:
generalScenario(validation='inter-session-split', training='fine-tuning', adaptationVersion=23)
generalScenario(validation='inter-session', training='fine-tuning', adaptationVersion=23)
generalScenario(validation='inter-session-split', training='fine-tuning', adaptationVersion=1000)
generalScenario(validation='inter-session', training='fine-tuning', adaptationVersion=1000)
generalScenario(validation='inter-session-split', training='fine-tuning', adaptationVersion=21)
generalScenario(validation='inter-session', training='fine-tuning', adaptationVersion=21)
generalScenario(validation='inter-session-split', training='fine-tuning', adaptationVersion=22)
generalScenario(validation='inter-session', training='fine-tuning', adaptationVersion=22)
generalScenario(validation='inter-session-split', training='fine-tuning', adaptationVersion=24)
generalScenario(validation='inter-session', training='fine-tuning', adaptationVersion=24)

#vasarnap ejjel:
generalScenario(validation='inter-session-split', training='fine-tuning', adaptationVersion=31)
generalScenario(validation='inter-session', training='fine-tuning', adaptationVersion=31)
generalScenario(validation='inter-session-split', training='fine-tuning', adaptationVersion=32)
generalScenario(validation='inter-session', training='fine-tuning', adaptationVersion=32)
generalScenario(validation='inter-session-split', training='fine-tuning', adaptationVersion=34)
generalScenario(validation='inter-session', training='fine-tuning', adaptationVersion=34)

#hetfo delben:
generalScenario(validation='inter-subject-split', training='fine-tuning', adaptationVersion=22)
generalScenario(validation='inter-subject', training='fine-tuning', adaptationVersion=22)
#idaig jutottunk.
